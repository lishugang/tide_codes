...
class Error_Analysis:
    def __init__(self, gt_path, dt_path, method_task, threshold):
    ...
    def data_prepare(self):
        ...
        res_dt_map05 = []
        for det in res_sorted:
            # print(det)
            if det['score'] > self.threshold:
                res_dt_map05.append(det)
        self.total = len(res_dt_map05)
        print(self.total)

        with open('dt_map05.json', 'w') as j:
            json.dump(res_dt_map05, j)
            self.dt_path = 'dt_map05.json'
    ...
    def run(self):
        ...
        # self.correct = 100*self.correct/9792
        # self.background = 100*self.background/9792
        # self.mis_localized = 100*self.mis_localized/9792
        # print('correct = {0}, mis_localized = {1}, background = {2}'.format(self.correct, self.mis_localized, self.background))
...
if __name__ == "__main__":
    ...
    # source 0.5 correct = 2883, mis_localized = 86, background = 171
    # source 0.7 correct = 1797, mis_localized = 14, background = 44
    dt_path = 'source_city2foggy.json'
    method_task = 'map05_source_city2foggy_'

    # sfa 0.5 correct = 4143, mis_localized = 190, background = 376
    # sfa 0.7 correct = 2355, mis_localized = 26, background = 58
    # dt_path = 'sfa_city2foggy.json'
    # method_task = 'map05_sfa_city2foggy_'

    # our 0.5 correct = 4791, mis_localized = 225, background = 497
    # our 0.7 correct = 3050, mis_localized = 51, background = 103
    # dt_path = 'ours_city2foggy.json'
    # method_task = 'map05_ours_city2foggy_'

    error_analysis = Error_Analysis(gt_path, dt_path, method_task, 0.7 )
